...
def _nn_euclidean_distance(x, y):
    ...
    distances = metrics.distance.compute_distance_matrix(x_, y_, metric='euclidean')
...
def _nn_cosine_distance(x, y):
    ...
    distances = _cosine_distance(x, y, True) #TODO shai - check if outer methos for cosine normalize data
