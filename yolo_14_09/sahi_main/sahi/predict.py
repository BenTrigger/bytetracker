...
from sahi_main.sahi.slicing_orig import slice_image
from sahi_main.sahi.utils.coco import Coco, CocoImage
from sahi_main.sahi.utils.cv import (
...
def predict(
    ...
    for ind, image_path in enumerate(tqdm(image_path_list)):
        ...
        if apply_sliced_prediction:
            ...
            #np.savetxt('/MyHomeDir/yolov5_master/sahi_main/sahi.txt', np.asarray(object_prediction_list))
